...
// Material 3 Expressive Font Family
val ExpressiveFont = FontFamily(
    ...
    // Note: We're using the variable fonts which support all weights
    // If we need specific weights, we would need to move the static font files
    // from the static subfolder directly to the font folder
)
